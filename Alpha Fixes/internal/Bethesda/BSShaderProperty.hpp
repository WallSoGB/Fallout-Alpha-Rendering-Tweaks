...
public:
	...
	public:
		enum AccumMode : UInt8 {
			ACCUM_NONE = 0x0,
			ACCUM_ALPHA_BLEND = 0x1,
			ACCUM_ALPHA_UNK_2 = 0x2,
			ACCUM_ALPHA_PARTICLE = 0x3,
			ACCUM_ALPHA_DECAL_SINGLE = 0x4,
			ACCUM_ALPHA_DYN_DECAL_SINGLE = 0x5,
			ACCUM_REFRACTION = 0x6,
			ACCUM_REFRACTION_CLEAR = 0x7,
			ACCUM_ALPHA_UNK_8 = 0x8,
			ACCUM_ALPHA_UNK_9 = 0x9,
			ACCUM_ALPHA_LOD = 0xA,
			ACCUM_ALPHA_UNK_11 = 0xB,
			ACCUM_ALPHA_UNK_12 = 0xC,
			ACCUM_ALPHA_UNK_13 = 0xD,
			ACCUM_ALPHA_FADE = 0xE,
		};
		...
		__forceinline BSShaderManager::RenderPassType GetPassType() { return (BSShaderManager::RenderPassType)usPassEnum; }
	...
	virtual RenderPassArray*			GetRenderPasses(NiGeometry* apGeometry, UInt32 auiEnabledPasses, WORD* pusPassCount, int a5, BSShaderAccumulator* apAccumulator, int a7);
	...
	virtual RenderPassArray*			WaterDepth(NiGeometry* pGeometry);
	virtual void						Unk_2D();
	...
	BSShaderProperty::RenderPassArray*	pRenderPassArray;				// Mistakenly called pRenderPassList, Oblivion leftover
	BSShaderProperty::RenderPassArray*	pRenderPassArray_depthMap;
	BSShaderProperty::RenderPassArray*	pRenderPassArray_constAlpha;
	BSShaderProperty::RenderPassArray*	pRenderPassArray_localMap;
	BSShaderProperty::RenderPassArray*	pRenderPassArray_unk4C;
	BSShaderProperty::RenderPassArray*	pRenderPassArray_waterDepth;
	BSShaderProperty::RenderPassArray*	pRenderPassArray_silhouette;
