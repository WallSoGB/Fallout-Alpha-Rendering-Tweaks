...
public:
	...
	void* m_spShaderDecl;
	void* m_pkRenderStateGroup;
	void* m_spPixelConstantMap;
	void* m_spVertexConstantMap;
	unsigned int m_uiCurrentPass;	// 038
};
...
public:
	...
	unsigned short m_ucAlphaTestRef;
};
...
public:
	virtual void	RenderImmediate(void* pkRenderer);
	virtual void	Unk_38();
	virtual void	SetModelData(void* pkModelData);
	virtual void	Unk_3A();
	...
	{
		NiAlphaProperty* m_alphaProperty;
		void* m_cullingProperty;
		void* m_materialProperty;
		NiShadeProperty* m_shadeProperty;
		void* m_stencilProperty;
		void* m_texturingProperty;
		NiPropertyState* m_spPropertyState;
	};

	NiGeometry::ShaderProperties shaderProperties;
	void* m_spModelData;
	void* m_spSkinInstance;
	void* m_spShaderDecl;
};
...
public:
	...
	enum BSShaderFlags
	{
		kFlags1_Specular = 0x1,
		kFlags1_Skinned = 0x2,
		kFlags1_LowDetail = 0x4,
		kFlags1_Vertex_Alpha = 0x8,
		kFlags1_Motion_Blur = 0x10,
		kFlags1_Single_Pass = 0x20,
		kFlags1_Empty = 0x40,
		kFlags1_Environment_Mapping = 0x80,
		kFlags1_Alpha_Texture = 0x100,
		kFlags1_Z_Prepass = 0x200,
		kFlags1_FaceGen = 0x400,
		kFlags1_Parallax_Shader = 0x800,
		kFlags1_Model_Space_Normals = 0x1000,
		kFlags1_Non_Projective_Shadows = 0x2000,
		kFlags1_Landscape = 0x4000,
		kFlags1_Refraction = 0x8000,
		kFlags1_Fire_Refraction = 0x10000,
		kFlags1_Eye_Environment_Mapping = 0x20000,
		kFlags1_Hair = 0x40000,
		kFlags1_Dynamic_Alpha = 0x80000,
		kFlags1_Localmap_Hide_Secret = 0x100000,
		kFlags1_Window_Environment_Mapping = 0x200000,
		kFlags1_Tree_Billboard = 0x400000,
		kFlags1_Shadow_Frustum = 0x800000,
		kFlags1_Multiple_Textures = 0x1000000,
		kFlags1_Remappable_Textures = 0x2000000,
		kFlags1_Decal_Single_Pass = 0x4000000,
		kFlags1_Dynamic_Decal_Single_Pass = 0x8000000,
		kFlags1_Parallax_Occulsion = 0x10000000,
		kFlags1_External_Emittance = 0x20000000,
		kFlags1_Shadow_Map = 0x40000000,
		kFlags1_ZBuffer_Test = 0x80000000,
	};
	...
	enum BSShaderFlags2
	{
		...
		kFlags2_Unknown10 = 0x80000000,
	};

	UInt32 BSShaderFlags[2];
	float fAlpha;
	float fFadeAlpha;
	float fEnvMapScale;
	float fLODFade;
	int iLastRenderPassState;
	void* kRenderPassList;
	void* pRenderPassList_depthMap;
	void* pRenderPassList_constAlpha;
	void* pRenderPassList_localMap;
	void* pRenderPassList_unk4C;
	void* pRenderPassList_waterDepth;
	void* pRenderPassList_silhoutte;
	unsigned int uiShaderIndex;
	float fDepthBias;
};
